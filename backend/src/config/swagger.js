...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'REST API for WakeelHub — Book verified lawyers in Pakistan. Auth, lawyers, appointments, cases, dashboards.',
      contact: { name: 'WakeelHub' },
    },
    servers: [
      { url: 'http://localhost:5001', description: 'Local development' },
      { url: 'http://localhost:5001/api', description: 'API base' },
    ],
    components: {
      securitySchemes: {
        bearerAuth: {
    ...
    paths: {
              ...
              'multipart/form-data': {
                schema: {
                  ...
                  properties: {
                    ...
                    education: { type: 'string', description: 'Optional text description of the qualification' },
                    qualificationDocument: { type: 'string', format: 'binary', description: 'Required for lawyers: PDF, PNG, or JPG certificate/degree (max 5 MB)' },
                  },
                },
              },
            },
          ...
          requestBody: {
            ...
            content: {
              'multipart/form-data': {
                schema: {
                  type: 'object',
                  required: ['name', 'email', 'password', 'qualificationDocument'],
                  properties: {
                    name: { type: 'string' },
                    email: { type: 'string' },
                    ...
                    education: { type: 'string', description: 'Optional text description of the qualification' },
                    qualificationDocument: { type: 'string', format: 'binary', description: 'PDF, PNG, or JPG certificate/degree (max 5 MB)' },
                    bio: { type: 'string' },
                  },
                },
              },
      ...
      '/api/dashboard/client': {
        get: {
          ...
          security: [{ bearerAuth: [] }],
          responses: { 200: { description: 'Stats, upcoming, cases, recommended lawyers' } },
        },
      },
      '/api/dashboard/lawyer': {
        get: {
          ...
          security: [{ bearerAuth: [] }],
          responses: { 200: { description: 'Stats, bookings, earnings, cases' } },
        },
      },
    },
  },
  apis: [], // paths defined above
};
