...
import { Calendar, FileText, CreditCard, User, Clock, Video, MapPin, ArrowRight, LogOut, Settings } from 'lucide-react'
    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <ul className="sidebar-nav">
          ...
          <li><Link to="/client/profile"><Settings size={18} /> My Profile</Link></li>
          <li>
            <button
              type="button"
