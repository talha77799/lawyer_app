...
export default function Signup() {
  ...
  // Shows a green check or red cross inside a field once the user has typed something.
  // `value` empty => no icon yet (don't scold someone for an untouched field).
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              ...
              />
              <ValidationIcon value={form.email} valid={EMAIL_REGEX.test(form.email.trim())} />
            </div>
          </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{ paddingRight: '2.5rem', width: '100%' }}
                />
                <ValidationIcon value={form.phone} valid={PHONE_REGEX.test(form.phone.trim())} />
              </div>
            </div>
            <div className="form-group">
