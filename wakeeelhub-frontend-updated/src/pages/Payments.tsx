    ...
    <main className="container" style={{ padding: '2.5rem 1.25rem', maxWidth: 980 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.25fr 1fr', gap: '1.5rem' }}>
        ...
        <section className="card" style={{ padding: '1.25rem' }}>
          ...
          <div style={{ marginTop: '1rem', padding: '0.75rem', background: 'var(--primary-light)', borderRadius: 8, color: 'var(--text)', fontSize: '0.8rem' }}>
            PayFast is available when booking a lawyer. <a href="https://gopayfast.com/" target="_blank" rel="noreferrer" style={{ color: 'var(--primary)', fontWeight: 600 }}>Learn about PayFast</a>
          </div>
        </section>
      </div>
    </main>
