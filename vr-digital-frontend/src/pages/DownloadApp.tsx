  ...
  return (
    <main className="container" style={{ padding: '3rem 1.25rem', maxWidth: 640 }}>
      <div className="card" style={{ padding: '2rem' }}>
        ...
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '0.5rem' }}>Download WakeelHub</h1>
        <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
          Use the WakeelHub mobile app to find lawyers, manage appointments, and track your cases.
        </p>
